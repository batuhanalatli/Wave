<template>
    <div class="border border-gray-200 p-3 mb-4 rounded">
        <div v-show="!showForm">
            <div class="text-white text-center text-bold p-4 mb-4" v-if="show_alert" :class="alert_variant">
                {{ alert_message }}</div>
        ...
        <div v-show="showForm">
            ...
            <vee-form :validation-schema="schema" :initial-values="song" @submit="edit">
                ...
                <button type="button" class="py-1.5 px-3 rounded text-white bg-gray-600" :disabled="in_submission"
                    @click.prevent="showForm = false, show_alert = false">
                    Go Back
                </button>
            </vee-form>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            alert_message: 'Please wait! Updatng song info.'
        };
    },
    methods: {
        async edit(values) {
            ...
            this.alert_message = 'Please wait! Updatng song info.';
